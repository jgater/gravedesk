...
var TicketProvider = function() {
	...
	this.findById = function(id, callback) {
		//TODO don't send attachments along with rest of ticket!
    ...
    if (searchstring) {
        ...
        ticketmodel.findById(substring,function(err,result){
        	if (err) {
        		...
        		result.attachments = results.attachments.concat(attachments);
  ...
  this.newTicket = function(params,callback) {
  	var self=this;
		...
		ticket.attachments = params.attachments.splice(0,params.attachments.length);
