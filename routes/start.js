...
module.exports = {
  ...
  index: function(req, res) {
  	res.render('index.jade', { title: settings.brand, brand: settings.brand, adminUser: req.user });
	},

  //app.get('/manage'... ensureAuthenticated, ...
  manage: function(req, res){
    res.render('manage/index.jade', { title: 'Manage Tickets - '+settings.brand, brand: settings.brand, adminUser: req.user });
  },
  ...
  getAccount: function(req, res) {
    res.render('account/index.jade', { title: 'Account - '+settings.brand, brand: settings.brand, adminUser: req.user });
  },
